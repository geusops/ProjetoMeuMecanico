      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10">
          ...
          <div className="bg-sky-50 p-6 rounded-xl border border-sky-100">
            <h2 className="text-xl font-semibold text-sky-800 mb-4">Informações da conta</h2>
            <div className="space-y-2">
              <p className="text-gray-700"><strong>Nome:</strong> {user.nome}</p>
              <p className="text-gray-700"><strong>Email:</strong> {user.email}</p>
              <p className="text-gray-700"><strong>Tipo:</strong> <span className="bg-sky-200 text-sky-700 px-2 py-1 rounded-full text-sm font-semibold">{user.tipo}</span></p>
            </div>
          </div>
        </div>
        ...
        {/* Botão Admin - aparece só para ADMIN */}
          {user.tipo === "ADMIN" && (
            <div className="bg-red-50 border border-red-200 p-6 rounded-2xl mt-6">
              <h2 className="text-xl font-semibold text-red-700 mb-3">🛡️ Acesso Administrativo</h2>
              <p className="text-gray-600 mb-4">Gerencie usuários e oficinas da plataforma.</p>
              <Link to="/admin">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-l-4 border-sky-500">
          <h2 className="text-xl font-semibold text-sky-800 mb-2">Você tem uma oficina mecânica?</h2>
          <p className="text-gray-600 mb-4">Cadastre sua oficina e apareça no mapa para novos clientes na sua região.</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <ul className="space-y-3 text-gray-500">
            ...
            <li className="flex items-center gap-2">📅 Histórico de agendamentos</li>
